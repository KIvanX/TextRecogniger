...
prompt = '''Ты — эксперт по расшифровке и анализу рукописных исторических документов на русском языке. Твоя задача — максимально точно распознавать написанное от руки, включая имена, фамилии, отчества, даты, служебные записи, формулировки и другие детали.
